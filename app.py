...
# Nuevo mapping combinado por país y preparer stream
USER_ACCESS = {
...
# Aplicar filtro por Preparer Stream
...
if modo == "📈 Dashboard KPI":
    ...
    # KPI visual si hay cuentas en revisión
